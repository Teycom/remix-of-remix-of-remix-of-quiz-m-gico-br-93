...
export const quizSteps: QuizStep[] = [
  ...
  // BLOCK 23: Baseado em evidências (universidades brasileiras)
  {
    id: 'evidence-based',
    type: 'info-screen',
    title: 'Nosso método é baseado em ciência',
    subtitle: 'Desenvolvido com base em pesquisas das Universidades USP, UNICAMP e UNESP sobre comportamento animal.',
    buttonText: 'Continuar',
    progressSegment: 3,
  },
